...
export default function Export() {
    return (<>
        ...
        <br />
        <Typography>
            To download all of the audio submissions your patients have shared with you to date, press the button below.
        </Typography>
        <br />
        ...
        <Typography>
            ...
            <ul>
                <li>a JSON file containing submission metadata — <strong>submissions.json</strong>; and</li>
                <li>WAV files of patients' audio submissions named <strong>submission_ID.wav</strong> (where "ID" is the identifier of a submission detailed in <em>submissions.json</em>)</li>
            </ul>

            As an example, an exported zip file of a single submission may contain an submission_1.wav file and a submissions.json file with the following contents:
            <br />
            <code>
                [ {'{'} <br />
                "submission_id": 1, <br />
