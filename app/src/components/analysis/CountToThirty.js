import { Box, Button, CircularProgress, LinearProgress, Paper, Typography, withStyles } from '@material-ui/core';
...
class CountToThirty extends React.Component {
    constructor(props) {
        super(props);
...
export default withStyles(myStyles)(CountToThirty);
